          ...
          <div className="lg:col-span-5 relative flex justify-center items-center h-[400px]">
            ...
            >
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  <h4 className="text-white font-bold text-xs uppercase tracking-wide">Featured App</h4>
                  <h3 className="text-white font-black text-sm">Fielmedina App</h3>
                </div>
              </div>
            ...
            <div className="floating-card-2 absolute z-15 right-4 bottom-10 w-64 p-5 rounded-2xl border border-white/10 bg-slate-950/70 backdrop-blur-md shadow-2xl">
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  <h4 className="text-white font-bold text-xs uppercase tracking-wide">Artificial Intelligence</h4>
                  <h3 className="text-white font-black text-sm">AI Agent System</h3>
                </div>
              </div>
              <p className="text-slate-400 text-xs leading-relaxed mb-3">
      ...
      <section className="py-12 border-y border-white/5 bg-slate-950/40 relative z-10 partners-trigger">
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row items-center gap-8 justify-between">
          <div className="flex flex-col gap-1 text-center md:text-left">
            <h3 className="text-slate-500 uppercase tracking-widest text-xs font-bold">Trusted Globally By</h3>
            <p className="text-slate-300 text-sm font-semibold">Leading brands trust our execution</p>
          </div>
          
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-12">
            {[
              { name: "Gisysco", url: "https://gisysco.com", logo: "" },
              ...
              { name: "Motobike", url: "https://www.motobike.com.tn", logo: "/images/motobike.png" },
              ...
              <div className="absolute inset-0 bg-slate-900 flex flex-col justify-between p-6 pt-10">
                <div className="flex flex-col gap-4">
                  <div className="flex justify-between items-center">
                    <span className="text-xs font-bold text-slate-500 uppercase tracking-widest">Fielmedina</span>
                ...
                <div className="flex flex-col gap-2">
                  <span className="text-[10px] text-slate-500 text-center font-mono">DEVELOPED BY DACNIS</span>
                  <a
                    href="https://www.fielmedina.com"
                    target="_blank"
                    rel="noopener noreferrer"
